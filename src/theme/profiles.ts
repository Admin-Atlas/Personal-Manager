...
export type Role =
  | "bg" | "panel" | "surface" | "border" | "border2" | "rule"
  | "ink" | "ink2" | "ink3" | "ink4" | "faint";
...
export const STATUS_KEYS: readonly StatusKey[] = [
  "due", "blocked", "quick", "look", "part", "track",
];
...
export const PROFILES: Record<System, Record<Mode, Ramp>> = {
  editorial: {
    dark: {
      bg: [0.165, 0.016], panel: [0.145, 0.016], surface: [0.205, 0.018], border: [0.265, 0.016], border2: [0.315, 0.016], rule: [0.235, 0.012],
      ink: [0.915, 0.018], ink2: [0.845, 0.020], ink3: [0.685, 0.018], ink4: [0.575, 0.016], faint: [0.485, 0.014],
    },
    light: {
      bg: [0.985, 0.008], panel: [0.962, 0.010], surface: [0.944, 0.012], border: [0.884, 0.013], border2: [0.820, 0.015], rule: [0.918, 0.010],
      ink: [0.290, 0.030], ink2: [0.405, 0.026], ink3: [0.520, 0.022], ink4: [0.600, 0.018], faint: [0.700, 0.014],
    },
  },
  slate: {
    dark: {
      bg: [0.155, 0.013], panel: [0.135, 0.013], surface: [0.205, 0.015], border: [0.255, 0.013], border2: [0.305, 0.015], rule: [0.225, 0.011],
      ink: [0.925, 0.013], ink2: [0.835, 0.015], ink3: [0.665, 0.015], ink4: [0.565, 0.013], faint: [0.455, 0.011],
    },
    light: {
      bg: [0.992, 0.004], panel: [0.974, 0.005], surface: [0.962, 0.006], border: [0.902, 0.008], border2: [0.845, 0.010], rule: [0.935, 0.006],
      ink: [0.265, 0.018], ink2: [0.385, 0.016], ink3: [0.510, 0.015], ink4: [0.600, 0.012], faint: [0.710, 0.009],
    },
  },
  terminal: {
    dark: {
      bg: [0.135, 0.007], panel: [0.115, 0.007], surface: [0.165, 0.007], border: [0.235, 0.007], border2: [0.285, 0.009], rule: [0.205, 0.006],
      ink: [0.865, 0.011], ink2: [0.795, 0.011], ink3: [0.585, 0.009], ink4: [0.495, 0.008], faint: [0.345, 0.007],
    },
    light: {
      bg: [0.967, 0.010], panel: [0.945, 0.011], surface: [0.934, 0.011], border: [0.860, 0.013], border2: [0.805, 0.013], rule: [0.905, 0.008],
      ink: [0.300, 0.018], ink2: [0.395, 0.016], ink3: [0.520, 0.013], ink4: [0.600, 0.011], faint: [0.690, 0.008],
    },
  },
};
