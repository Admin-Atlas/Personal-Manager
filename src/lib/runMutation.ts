 ...
 *  just the try/catch seam the milestone handlers were missing. The connector blocks layer a
 *  busy label on top via {@link "./useBusyRun"}; the Teach view's local `run` is the fuller
 *  busy+error+reload version of the same shape. */
