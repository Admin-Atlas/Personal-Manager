...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    highlights: [
      ...
      "For power users: turn the density up to Power and the reader gains a “Show chunks” view that paints the exact boundaries PM used to split a document for search — so you can see how a file was divided (for anything with full text, including your cloud and folder items). It's read-only, and (in developer mode) can show the raw source with the same boundaries. Nothing is re-indexed or changed by looking.",
    ],
  },
  {
