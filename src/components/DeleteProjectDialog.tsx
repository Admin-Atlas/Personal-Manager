...
export function DeleteProjectDialog({
  ...
  return (
    <Modal open onClose={() => (busy ? undefined : onClose())} widthClassName="max-w-lg">
      <div className="p-5">
        <h2 className="font-head text-base font-semibold text-ink">Delete “{project}”</h2>
        ...
        {preview && (
          <>
            ...
            {/* Not a choice — so it is stated, not offered. */}
            <p
              className="mt-4 rounded-[var(--radius-sm)] border px-3 py-2 text-sm text-ink2"
              style={{
